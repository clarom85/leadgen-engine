...
INSERT INTO buyers (name, active, active_in_verticals, ping_url, post_url, auth_type, auth_config, field_mapping, filters, exclusive, max_bid, notes) VALUES (
  ...
  true,
  ARRAY['elder-wealth'],
  'http://127.0.0.1:3010/api/_mock/buyer/smartasset/ping',
  'http://127.0.0.1:3010/api/_mock/buyer/smartasset/post',
  'bearer',
...
INSERT INTO buyers (name, active, active_in_verticals, ping_url, post_url, auth_type, auth_config, field_mapping, filters, exclusive, max_bid, notes) VALUES (
  ...
  true,
  ARRAY['elder-wealth'],
  'http://127.0.0.1:3010/api/_mock/buyer/trustwill/ping',
  'http://127.0.0.1:3010/api/_mock/buyer/trustwill/post',
  'apikey',
...
INSERT INTO buyers (name, active, active_in_verticals, ping_url, post_url, auth_type, auth_config, field_mapping, filters, exclusive, max_bid, notes) VALUES (
  ...
  true,
  ARRAY['elder-wealth'],
  'http://127.0.0.1:3010/api/_mock/buyer/aag/ping',
  'http://127.0.0.1:3010/api/_mock/buyer/aag/post',
  'bearer',
...
INSERT INTO buyers (name, active, active_in_verticals, ping_url, post_url, auth_type, auth_config, field_mapping, filters, exclusive, max_bid, notes) VALUES (
  ...
  true,
  ARRAY['elder-wealth'],
  'http://127.0.0.1:3010/api/_mock/buyer/mutual-ltc/ping',
  'http://127.0.0.1:3010/api/_mock/buyer/mutual-ltc/post',
  'basic',
